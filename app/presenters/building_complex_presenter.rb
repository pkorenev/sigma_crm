    ...
    content_tag :div, class: "group address" do
      content_tag(:h3, "Адреса") +
        content_tag(:div, class: "group-content") do
          form.input(:google_formatted_address, label: false, input_html: {id: "building_complex_address_autocomplete", class: "form-control address_autocomplete", placeholder: "Введіть адресу"}, required: required) +
