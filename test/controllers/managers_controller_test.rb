...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { avatar: @manager.avatar, email: @manager.email, full_address: @manager.full_address, full_name: @manager.full_name }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { avatar: @manager.avatar, email: @manager.email, full_address: @manager.full_address, full_name: @manager.full_name }
    assert_redirected_to manager_path(assigns(:manager))
  end
